...
export class PatientAddComponent implements OnInit {
  ...
  onSubmit() {
    var body = "\{\"name\": \""+this.name+"\",\"surname\": \""+this.surname+"\",\"bitrhdate\": \""+this.birthdate+"\",\"pesel\":"+this.pesel+",\"department_id\":"+this.department_id+",\"weight\": "+this.weight+",\"height\":"+this.height+"\}";
